...
for i in range(3): #Seconds before it starts  processor
        type_me = tabbing_mech(lines) #Used for IDEs
        pyautogui.typewrite(type_me, delay_speed)typing
    time.sleep(1)
    print(i)

with open("code.txt", 'r') as f:
    for lines in f:
        #type_me = lines #Use this if on a word
our code here :-)
